...
public class PeakPOJO extends RealmObject {
    @PrimaryKey
    @NotNull
    ...
    public PeakPOJO(ObjectId _id, String _partition, String name, String time, String date, String ForwardAngle, String BackwardAngle, String
